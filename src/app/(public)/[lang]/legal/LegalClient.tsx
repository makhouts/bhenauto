...
function CookieContent({ locale }: { locale: Locale }) {
  const t = {
    nl: {
      intro: "Deze website gebruikt technisch noodzakelijke cookies en beperkte privacyvriendelijke first-party analytics. Er worden geen marketingcookies, advertentiecookies of third-party tracking pixels geplaatst.",
      ...
      whatItems: [
        ...
        "<strong>Beperkte first-party analytics:</strong> Wij meten paginaweergaven, voertuiginteresse en contact-/afspraakaanvragen zonder advertentie- of cross-site trackingcookies. Waar mogelijk gebruiken wij gehashte, tijdelijke identifiers op serverniveau.",
        "<strong>Geen marketingtracking:</strong> Wij plaatsen geen Facebook Pixel, advertentienetwerkcookies of vergelijkbare marketingtags.",
      ],
      noConsentTitle: "2.2 — Waarom geen cookiebanner?",
      noConsentText: "Conform de Belgische implementatie van de ePrivacy-richtlijn (Wet van 13 juni 2005) en de GDPR/AVG zijn strikt noodzakelijke cookies vrijgesteld van toestemming. Omdat deze website geen advertentie- of marketingcookies plaatst en de beperkte analytics first-party en cookieloos is opgezet, tonen wij geen cookiebanner voor toestemming.",
      retentionTitle: "2.3 — Bewaartermijn",
      retentionText: "Sessiecookies worden automatisch verwijderd bij het sluiten van uw browser. Analyticsgegevens worden server-side bewaard voor operationele rapportering gedurende een beperkte periode en niet gebruikt voor advertentieprofielen.",
      contactTitle: "2.4 — Vragen?",
      contactText: "Voor vragen over het cookiebeleid kunt u contact opnemen via",
    },
    fr: {
      intro: "Ce site web utilise des cookies strictement nécessaires ainsi que des statistiques first-party limitées et respectueuses de la vie privée. Aucun cookie marketing, publicitaire ni pixel tiers de suivi n'est installé.",
      ...
      whatItems: [
        ...
        "<strong>Statistiques first-party limitées :</strong> Nous mesurons les pages vues, l'intérêt pour les véhicules et les demandes de contact / rendez-vous sans cookies publicitaires ni suivi cross-site. Lorsque c'est possible, nous utilisons des identifiants hachés et temporaires côté serveur.",
        "<strong>Pas de marketing tracking :</strong> Nous n'utilisons pas Facebook Pixel, de cookies publicitaires ni de tags marketing similaires.",
      ],
      noConsentTitle: "2.2 — Pourquoi pas de bannière de cookies ?",
      noConsentText: "Conformément à la transposition belge de la directive ePrivacy (loi du 13 juin 2005) et au RGPD, les cookies strictement nécessaires sont exemptés de consentement. Comme ce site ne dépose pas de cookies publicitaires ou marketing et que les statistiques limitées sont configurées en first-party sans cookies, aucune bannière de consentement n'est affichée.",
      retentionTitle: "2.3 — Durée de conservation",
      retentionText: "Les cookies de session sont automatiquement supprimés à la fermeture du navigateur. Les données statistiques sont conservées côté serveur pendant une durée limitée pour le reporting opérationnel et ne servent pas à créer des profils publicitaires.",
      contactTitle: "2.4 — Questions ?",
      contactText: "Pour toute question relative à cette politique, contactez-nous à",
    },
    en: {
      intro: "This website uses strictly necessary technical cookies together with limited privacy-friendly first-party analytics. No marketing cookies, advertising cookies, or third-party tracking pixels are placed.",
      ...
      whatItems: [
        ...
        "<strong>Limited first-party analytics:</strong> We measure page views, vehicle interest, and contact / appointment submissions without advertising cookies or cross-site tracking cookies. Where possible, we use hashed temporary identifiers on the server side.",
        "<strong>No marketing tracking:</strong> We do not place Facebook Pixel, ad network cookies, or similar marketing tags.",
      ],
      noConsentTitle: "2.2 — Why no cookie banner?",
      noConsentText: "Under the Belgian implementation of the ePrivacy Directive (Law of 13 June 2005) and the GDPR, strictly necessary cookies are exempt from consent. Because this website does not place advertising or marketing cookies and the limited analytics is configured as first-party and cookieless, we do not display a consent banner.",
      retentionTitle: "2.3 — Retention period",
      retentionText: "Session cookies are automatically deleted when you close your browser. Analytics data is stored server-side for a limited reporting period and is not used to build advertising profiles.",
      contactTitle: "2.4 — Questions?",
