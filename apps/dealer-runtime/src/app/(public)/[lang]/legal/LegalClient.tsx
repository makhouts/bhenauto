...
import { DEFAULT_TENANT_BOOTSTRAP, getTenantBootstrapAddress } from "@/lib/tenant-bootstrap";
...
function PrivacyContent({ locale }: { locale: Locale }) {
  ...
  return (
    <>
      ...
      <InfoGrid items={[
        { icon: <MapPin size={15} />, label: t.addr, value: getTenantBootstrapAddress(DEFAULT_TENANT_BOOTSTRAP) },
        { icon: <FileText size={15} />, label: t.vat, value: "BE 0542.809.426" },
        { icon: <Mail size={15} />, label: t.email, value: <PublicEmail /> },
        { icon: <Phone size={15} />, label: t.phone, value: DEFAULT_TENANT_BOOTSTRAP.phone },
      ]} />
