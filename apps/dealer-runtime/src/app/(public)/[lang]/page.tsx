...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      title: `${DEFAULT_TENANT_BOOTSTRAP.displayName} | ${dict.home.heroLabel}`,
      description: dict.home.heroSubtitle,
    },
    twitter: {
...
const localBusinessJsonLd = {
  ...
  "@type": "AutoDealer",
  "name": DEFAULT_TENANT_BOOTSTRAP.displayName,
  "url": DEFAULT_TENANT_BOOTSTRAP.siteUrl,
  "telephone": DEFAULT_TENANT_BOOTSTRAP.phone,
  "address": {
    "@type": "PostalAddress",
    "streetAddress": DEFAULT_TENANT_BOOTSTRAP.addressLine,
    "addressLocality": DEFAULT_TENANT_BOOTSTRAP.city,
    "addressRegion": DEFAULT_TENANT_BOOTSTRAP.region,
    "postalCode": DEFAULT_TENANT_BOOTSTRAP.postalCode,
    "addressCountry": DEFAULT_TENANT_BOOTSTRAP.countryCode,
  },
  "geo": {
    "@type": "GeoCoordinates",
    "latitude": 50.898611,
