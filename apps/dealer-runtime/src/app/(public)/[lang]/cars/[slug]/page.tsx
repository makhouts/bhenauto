...
import { DEFAULT_TENANT_BOOTSTRAP, getTenantBootstrapWhatsappUrl } from '@/lib/tenant-bootstrap';
...
export default async function CarDetailPage(
    ...
    const whatsappUrl = `${getTenantBootstrapWhatsappUrl()}?text=${whatsappMsg}`;
