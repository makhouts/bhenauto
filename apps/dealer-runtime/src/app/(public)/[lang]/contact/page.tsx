          ...
          <div className="lg:col-span-2 flex flex-col gap-5">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="theme-text font-bold text-sm leading-relaxed">
                    {DEFAULT_TENANT_BOOTSTRAP.addressLine}<br />
                    {DEFAULT_TENANT_BOOTSTRAP.postalCode} {DEFAULT_TENANT_BOOTSTRAP.city}, België
                  </p>
                  <a
                    href={`https://maps.google.com/?q=${encodeURIComponent(getTenantBootstrapAddress(DEFAULT_TENANT_BOOTSTRAP))}`}
                    target="_blank"
            ...
            >
              ...
              <div className="space-y-4">
                <a href={getTenantBootstrapPhoneHref()} className="flex items-center gap-3 group/link">
                  <div
                  ...
                  <div>
                    ...
                    <p className="theme-text font-bold text-sm">{DEFAULT_TENANT_BOOTSTRAP.phone}</p>
                  </div>
                </a>
