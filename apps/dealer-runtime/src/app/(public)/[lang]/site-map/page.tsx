...
export async function generateMetadata({
  ...
  const descriptions: Record<string, string> = {
    nl: `Bekijk alle belangrijke ${DEFAULT_TENANT_BOOTSTRAP.displayName}-pagina's en beschikbare voertuigen op een overzichtelijke sitemap.`,
    fr: `Consultez toutes les pages importantes de ${DEFAULT_TENANT_BOOTSTRAP.displayName} et les véhicules disponibles dans un plan du site clair.`,
    en: `View all important ${DEFAULT_TENANT_BOOTSTRAP.displayName} pages and available vehicles in a clear website sitemap.`,
  };
  return {
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-14">
          <div className="inline-flex items-center gap-2 text-[10px] font-black tracking-[0.22em] uppercase text-[#d91c1c] mb-4">
            <Globe size={12} />
            {DEFAULT_TENANT_BOOTSTRAP.displayName}
          </div>
