        ...
        >
            ...
            >
                ...
                <div className="space-y-4 mb-8 relative z-10">
                    {/* Phone */}
                    <a href={getTenantBootstrapPhoneHref()} className="group flex items-center rounded-[16px] p-4 transition-all duration-300 hover:shadow-md hover:border-[#d91c1c]/30"
                        ...
                        <div className="text-left">
                            ...
                            <p className="text-lg font-black theme-text tracking-tight group-hover:text-[#d91c1c] transition-colors">{DEFAULT_TENANT_BOOTSTRAP.phone}</p>
                        </div>
                    </a>
