...
export default function CarsTableClient({
    cars,
    autoscoutEnabled,
}: {
    cars: AdminCarRow[];
            ...
            <div className="px-5 py-5 sm:px-6">
                <AdminToolbar>
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        {autoscoutEnabled && autoscoutProblemCount > 0 ? (
                ...
                <table className="min-w-[1120px] w-full text-left border-collapse">
                    <thead className="sticky top-0 z-10">
                        <tr className="border-b border-slate-200 bg-slate-50/95 text-xs uppercase tracking-widest text-slate-500 backdrop-blur">
                            ...
                            {autoscoutEnabled ? renderSortButton("autoscout", dict.carsTable.columns.autoscout) : null}
                    ...
                    <tbody key={`${quickFilter}:${query}`} className="motion-safe:animate-[fadeIn_220ms_ease-out]">
                        {filtered.length === 0 ? (
                            <tr>
                                <td colSpan={autoscoutEnabled ? 7 : 6} className="px-6 py-16 text-center text-slate-500 font-medium">
                                    {query ? (
