...
export default async function ConditionalLayout({
  ...
  const workshopEnabled = await isCurrentTenantFeatureEnabled("appointments");

  return (
    <ClientConditionalLayout
      header={<Header dict={dict.nav} workshopEnabled={workshopEnabled} />}
      footer={<Footer dict={dict.footer} workshopEnabled={workshopEnabled} />}
      whatsApp={
        <WhatsAppButton
