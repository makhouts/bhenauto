...
export default function Header({ dict, workshopEnabled }: HeaderProps) {
    ...
    const navLinks = [
        ...
        ...(workshopEnabled ? [{ name: dict.werkplaats, href: `/${locale}/werkplaats` }] : []),
                    ...
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="flex-shrink-0 flex items-center" style={{ zIndex: 70 }}>
                            <Link href={`/${locale}`} onClick={() => setIsOpen(false)} className="mr-12 block hover:opacity-80 transition-opacity duration-300">
                                <Image
                                    src={logo}
                                    alt={DEFAULT_TENANT_BOOTSTRAP.displayName}
                                    width={170}
                                    loading="eager"
